...
# Le code est copié dans ton repo (components/ui), à toi de le styler.`,cursor_prompt:"Initialise shadcn/ui dans un projet Next.js 15 + Tailwind v4. Ajoute Button, Card, Tabs, Sheet, Accordion. Configure le theme avec mes couleurs primaires #FF7E5F et accent #1F2937, radius 0.75rem.",docs_url:"https://ui.shadcn.com/docs"},{id:"wp-menu-react-nav",wp_term:"wp_nav_menu()",modern_term:"Composant Nav React + Sheet mobile (Framer Motion)",category:"layout",summary:"Le menu WP devient un simple composant React avec un état d'ouverture mobile, animé via Framer Motion (ou les sheets shadcn).",snippet_lang:"tsx",snippet_code:`'use client';
