...
export const Badge: React.FC<BadgeProps> = ({ children, color, onClick }) => {
    const colorClasses: Record<string, string> = {
        ...
        orange: 'bg-orange-100 text-orange-700 border-orange-200 dark:bg-orange-900/30 dark:text-orange-400 dark:border-orange-800/50',
...
export const Card: React.FC<CardProps> = ({ children, className = '', onClick }) => (
    <div 
        onClick={onClick}
        className={`glass rounded-4xl p-6 shadow-sm dark:shadow-none border border-[#E4E6EA] bg-white dark:border-[#262626] dark:bg-[#151516]/95 ${className}`}
    >
        {children}
    </div>
);
