...
export const AppHeader: React.FC<AppHeaderProps> = ({ isConfigured, isBackendDown, onReconnect }) => {
    ...
    return (
        <>
        <header className="sticky top-0 z-50 flex justify-between items-center px-2 sm:px-3 md:px-6 py-2 md:py-4 mb-2 md:mb-0 bg-[#1e1e1e]/92 dark:bg-[#0d1329]/90 md:bg-transparent md:dark:bg-transparent backdrop-blur-md md:backdrop-blur-none border-b border-[#2a2a2a] dark:border-[#262626] md:border-0">
            ...
            <div className="hidden md:flex items-center gap-0.5 md:gap-2 bg-[#252525] dark:bg-[#151516]/90 px-2 md:px-3 py-1 md:py-1.5 rounded-full border border-[#2a2a2a] dark:border-[#262626] shadow-none backdrop-blur-md md:-mt-2 transition-all duration-300">
