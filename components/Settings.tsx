                        ...
                        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    <button 
                                        ...
                                        className={`p-4 rounded-2xl border-2 flex flex-col gap-3 transition-all h-32 relative overflow-hidden ${
                                            ...
                                            : 'border-[#262626] bg-[#0d1329] opacity-70 hover:opacity-100 hover:border-[#3f3f46]'
                                        }`}
                                    >
                                        <div className="absolute inset-0 bg-[#0d1329]" />
                                        ...
                                        <div className="flex items-center gap-3 z-10">
                                            ...
                                            <span className="font-bold text-white">Nuit</span>
                                        </div>
                                        <p className="text-xs text-[#8A8A8E] z-10 text-left">
                                            Fond nuit `#0d1329` — bleu encre profond, surfaces #151516.
                                        </p>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex gap-4">
                                    {['#7C9A7E', '#b05070', '#4a72c4', '#2aada0'].map((color) => (
                                        <button 
                                            key={color}
