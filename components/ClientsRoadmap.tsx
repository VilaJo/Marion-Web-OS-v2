...
export const ClientsRoadmap: React.FC<ClientsRoadmapProps> = ({
    ...
    return (
        <div className="rounded-lg border border-[#E0DFDB] dark:border-[#262626] bg-white dark:bg-[#151516] overflow-hidden flex flex-col md:flex-row min-h-[460px] shadow-sm dark:shadow-none">
            {/* Left rail — dossiers + clients */}
            <aside className="md:w-64 shrink-0 border-b md:border-b-0 md:border-r border-[#E0DFDB] dark:border-[#262626] flex flex-col bg-[#F8F7F4] dark:bg-[#111318] max-h-[70vh] md:max-h-none">
                {/* Dossiers */}
